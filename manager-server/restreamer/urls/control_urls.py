...
from restreamer.views.streaming_event import (
    CreateStreamView,
    StreamingEventDetailView,
    StreamingEventEdit,
    StreamingEventView,
    VideoLengthData,
)
from restreamer.views.user_control import (
    AddEndpoint,
    DeleteChunkData,
    DownloadPageView,
    DownloadRestreamer,
...
from restreamer.views.youtube import YtLivePage
...
urlpatterns = [
    ...
    path(
        "remove-endpoint/<int:streaming_event_id>/<int:endpoint_id>/", RemoveEndpoint.as_view(), name="remove_endpoint"
    ),
    ...
    path(
        "<int:streaming_event_id>/streaming_event_active/", IsDeliveringActive.as_view(), name="streaming_event_active"
    ),
