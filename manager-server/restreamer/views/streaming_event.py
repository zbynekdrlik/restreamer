...
from ..models import EndPointCfg, StreamingEvent
...
class StreamingEventView(View):
    def get(self, request):
        ...
        context = {
            ...
            "is_buffering": video_manager.is_buffer_filled(buffer_time) if video_manager else None,
        }
...
class StreamingEventDetailView(View):
    def get(self, request, *args, **kwargs):
        ...
        available_endpoints = EndPointCfg.objects.filter(user=request.user).exclude(
