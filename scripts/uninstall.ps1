...
# Usage: irm https://raw.githubusercontent.com/zbynekdrlik/restreamer/main/scripts/uninstall.ps1 | iex
...
if (-not $isAdmin) {
    $script = "irm https://raw.githubusercontent.com/zbynekdrlik/restreamer/main/scripts/uninstall.ps1 | iex"
