...
class StreamingEventAdmin(ModelAdminObjectActionsMixin, admin.ModelAdmin):
    ...
    def received_speed(self, instance):
        ...
        try:
            ...
            if last_chunks:
                ...
                time_delta = (
                    last_chunks.last().created_at - last_chunks.first().created_at
                )
    ...
    def switch_receiving(self, instance, form):
        ...
        if instance.receiving_activated:
            instance.receiving_activated = (
                False  # Ak je pôvodná hodnota True, nastavíme na False
            )
            instance.save()
            ...
            instance.receiving_activated = (
                True  # Ak je pôvodná hodnota False, nastavíme na True
            )
            instance.save()
