...
export default defineConfig({
  ...
  testMatch: /(frontend|audit-panel|zero-endpoint-banner|remove-last-endpoint-modal|endpoint-history-sparkline|cache-drift-panel|delete-cleanup-button|rust-pusher|oauth-authorize)\.spec\.ts$/,
  timeout: 30000,
  retries: 0,
